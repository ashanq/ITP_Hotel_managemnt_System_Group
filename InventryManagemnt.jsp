            ...
            <div class="row">
                <div  class="col-3 col-m-6 col-sm-6">
                    ...
                    <div  class="counter bg-primary">
                        <p><a href="SearchE.jsp" style="color:#FFFFFF">
                ...
                <div class="col-3 col-m-6 col-sm-6">
                    <div class="counter bg-warning">
                        <a href="addinventry.jsp" style="color:#FFFFFF">
                            <p>
                                <i class="fa fa-money"></i>
                            </p>
                            <h3>100+</h3>
                ...
                <div class="col-3 col-m-6 col-sm-6">
                    <div class="counter bg-danger">
                        <a href="inventryaccount.jsp" style="color:#FFFFFF">
                            <p>
                                <i class="fa fa-money"></i>
                            </p>
                            <h3>100+</h3>
                ...
                <form action="getAllInventoriesServlet" method="post">
        	<input type="submit" name="getIn" value="Inventories Listing">
        </form>
            </div>
        </div>
